...
import com.designproject.Hardwareapp.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            locationName = "BuildMate Hardware, Galle Road, Hikkaduwa";
...
//         Add a marker in BuildMate Hardware Shop and move the camera
